  ...
  \begin{center}
    \begin{figure}
      \begin{overprint}
        ...
        \onslide<1>\centering\fbox{\includegraphics[width=.55\textwidth]{VMWare1.png}}
        \onslide<2>\centering\fbox{\includegraphics[width=.4\textwidth]{VMWare2.png}}
        \onslide<3>\centering\fbox{\includegraphics[width=.4\textwidth]{VMWare3.png}}
        \onslide<4>\centering\fbox{\includegraphics[width=.4\textwidth]{VMWare4.png}}
        \onslide<5>\centering\includegraphics[width=.4\textwidth]{VMWare5.png}
        \onslide<6>\centering\fbox{\includegraphics[width=.4\textwidth]{VMWare6.png}}
        \onslide<7>\centering\fbox{\includegraphics[width=.4\textwidth]{VMWare7.png}}
        \onslide<8>\centering\fbox{\includegraphics[width=.5\textwidth]{VMWare8.png}}
        \onslide<9>\centering\fbox{\includegraphics[width=.5\textwidth]{VMWare9.png}}
        \onslide<10>\centering\fbox{\includegraphics[width=.4\textwidth]{VMWare10.png}}
      \end{overprint}      
    \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}{Install \texttt{Ubuntu Server} (\texttt{Ubuntu})}
  \begin{figure}
    \begin{overprint}
      \setlength{\fboxsep}{0pt}%
      \setlength{\fboxrule}{0.5pt}%
      \onslide<1>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu1.png}}
      \onslide<2>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu2.png}}
      \onslide<3>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu3.png}}
      \onslide<4>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu4.png}}
      \onslide<5>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu5.png}}
      \onslide<6>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu6.png}}
      \onslide<7>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu7.png}}
      \onslide<8>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu8.png}}
      \onslide<9>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu9.png}}
      \onslide<10>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu10.png}}
      \onslide<11>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu11.png}}
      \onslide<12>\centering\fbox{\includegraphics[width=.65\textwidth]{Ubuntu12.png}}
    \end{overprint}
  \end{figure}
\end{frame}
...
\begin{frame}{Editing Config files}
  ...
  \end{itemize}
  \begin{block}{NOTE}
    On a \texttt{headless server} you can only use a simple text editor (you usually you navigate around the file using arrow keys i.e. \keys{\textuparrow}, \keys{\textdownarrow}, \keys{\textleftarrow}, \keys{\textrightarrow} and actions via \keys{ctrl} keys e.g. \keys{ctrl + s}).\\~\\
